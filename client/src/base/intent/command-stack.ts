...
export class CommandStack implements ICommandStack {
    ...
    /**
     * Executes all the commands and returns the new model or a promise for it
    ...
    /**
     * Executes a command and returns a promise with the new model or a promise for it
    ...
    /**
     * Undo the last executed command and returns a promise with the new model or a promise for it
     * 
    ...
    /**
     * Redo the last undo'ed command and returns a promise with the new model or a promise for it
     * 
    ...
    /**
     * Handles the correct operation for a given command and context.
